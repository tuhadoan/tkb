	...
	class DT_VisualComposer {
		...
		public function map() {
			...
			vc_map( 
				array( 
					...
					'default_content' => '
					  [dt_carousel_item title="' .
						 __( 'Item 1', 'dawnthemes' ) . '" tab_id="' . time() . '-1-' . rand( 0, 100 ) .
						 '"][/dt_carousel_item]
					  [dt_carousel_item title="' .
						 __( 'Item 2', 'dawnthemes' ) . '" tab_id="' . time() . '-2-' . rand( 0, 100 ) .
						 '"][/dt_carousel_item]
					  [dt_carousel_item title="' .
						 __( 'Item 3', 'dawnthemes' ) . '" tab_id="' . time() . '-3-' . rand( 0, 100 ) . '"][/dt_carousel_item]
					  ' ) );
			vc_map( 
				array( 
				...
				array( 
					...
					'default_content' => '
					  ...
					  [dt_testimonial_item title="' .
						 ...
						 '"][/dt_testimonial_item]
					  [dt_testimonial_item title="' .
						 __( 'Item 3', 'dawnthemes' ) . '" tab_id="' . time() . '-3-' . rand( 0, 100 ) . '"][/dt_testimonial_item]
					  ' ) );
			vc_map( 
				array( 
			...
			if ( ! empty( $brands ) ) {
				foreach ( $brands as $brand ) :
					$output .= '<option value="' . esc_attr( $brand->slug ) . '"' .
						 selected( in_array( $brand->slug, $brands_slugs ), true, false ) . '>' .
		...
		public function enqueue_scripts() {
			...
			wp_register_script( 
				...
				array( 'jquery', 'jquery-ui-datepicker', 'wpb_js_composer_js_custom_views' ), 
				DTINC_VERSION, 
				true );
			$dhvcL10n = array( 
			...
			wp_localize_script( 'dt-vc-custom', 'dhvcL10n', $dhvcL10n );
