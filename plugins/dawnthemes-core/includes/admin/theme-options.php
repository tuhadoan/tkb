				...
				'blog' => array( 
					...
					'fields' => array( 
						...
						array( 
							...
							'options' => array( 
								'default' => esc_html__( 'Default', 'dawnthemes' ), 
								'medium' => esc_html__( 'Medium', 'dawnthemes' ), 
								'grid' => esc_html__( 'Grid', 'dawnthemes' ), 
								'masonry' => esc_html__( 'Masonry', 'dawnthemes' ), 
								'timeline' => esc_html__( 'Timeline', 'dawnthemes' ) ), 
							'value' => 'default' ), 
						array( 
							'name' => 'blogs-columns', 
							'type' => 'image_select', 
						...
						array( 
							...
							'options' => array( 
								'page_num' => esc_html__( 'Page Number', 'dawnthemes' ), 
								'loadmore' => esc_html__( 'Load More Button', 'dawnthemes' ), 
								'infinite_scroll' => esc_html__( 'Infinite Scrolling', 'dawnthemes' ), 
								'no' => esc_html__( 'No', 'dawnthemes' ) ), 
							'value' => 'page_num', 
						...
						array( 
							...
							'on' => esc_html__( 'Show', 'dawnthemes' ), 
							'off' => esc_html__( 'Hide', 'dawnthemes' ), 
							'label' => esc_html__( 'Show/Hide Title', 'dawnthemes' ), 
							'desc' => esc_html__( 
						...
						array( 
							...
							'type' => 'switch', 
							'label' => esc_html__( 'Link Title To Post', 'dawnthemes' ), 
							'desc' => esc_html__( 
						...
						array( 
							...
							'on' => esc_html__( 'Show', 'dawnthemes' ), 
							'off' => esc_html__( 'Hide', 'dawnthemes' ), 
							'label' => esc_html__( 'Show Featured Image', 'dawnthemes' ), 
							'desc' => esc_html__( 'In Archive Blog. Show/Hide the post featured Image', 'dawnthemes' ), 
							'value' => '1' ),  // 1 = checked | 0 = unchecked
						array( 
