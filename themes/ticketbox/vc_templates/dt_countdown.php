...
<div class="countdown-item">
	<div class="countdown-item-label">'.__('Days','woow').'</div>
	<div class="countdown-item-value">%D</div>
</div>
<div class="countdown-item">
	<div class="countdown-item-label">'.__('Hours','woow').'</div>
	<div class="countdown-item-value">%H</div>
</div>
<div class="countdown-item">
	<div class="countdown-item-label">'.__('Minuts','woow').'</div>
	<div class="countdown-item-value">%M</div>
</div>
<div class="countdown-item">
	<div class="countdown-item-label">'.__('Seconds','woow').'</div>
